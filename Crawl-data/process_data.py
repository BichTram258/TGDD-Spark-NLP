...
with open(r'E:\TGDD-Spark-NLP\teencode.txt', encoding='utf-8') as f:
...
# Word segmentation
# annotator = VnCoreNLP(r'E:\TGDD-Spark-NLP\NLP\VnCoreNLP-1.1.1.jar') 
# print("c")
# def word_segmentation_batch(text_list):
#     batch_words = annotator.tokenize(text_list)
#     return [' '.join(word for word in flatten(words)) for words in batch_words]
